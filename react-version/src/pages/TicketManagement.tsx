...
const TicketManagement: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-purple-50 via-blue-50 to-indigo-100">
      {/* Navigation */}
      <nav className="bg-white shadow-lg" data-testid="test-react-ticket-nav">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              <Link to="/dashboard" className="text-2xl font-bold text-purple-600" data-testid="test-react-ticket-brand">
                TicketStressed
              </Link>
              <span className="text-gray-500">|</span>
              <span className="text-gray-700" data-testid="test-react-ticket-page-title">Ticket Management</span>
            </div>
            <div className="flex items-center space-x-4">
              <Link
                to="/dashboard"
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-2">Manage all your tickets in one place</p>
          </div>
          <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          {tickets.length === 0 ? (
            ...
            tickets.map((ticket) => (
              <div key={ticket.id} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
